...
def add_camera_args(parser):
    ...
    parser.add_argument('--rtsp', type=str, default='rtsp://192.168.1.10:554/media/1/1/Profile3',
                        help=('RTSP H.264 stream, e.g. '
                              'rtsp://admin:123456@192.168.1.64:554'))
    parser.add_argument('--rtsp_latency', type=int, default=1,
...
def open_cam_usb(dev, width, height):
    ...
    if USB_GSTREAMER:
        ...
        return cv2.VideoCapture("http://192.168.219.105:8080/video")
